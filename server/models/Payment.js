...
const paymentSchema = new mongoose.Schema({
  ...
  // Individual supervision session payment (therapist → therapist booking)
  supervisionSessionId: { type: mongoose.Schema.Types.ObjectId, ref: 'SupervisionSession', default: null },
